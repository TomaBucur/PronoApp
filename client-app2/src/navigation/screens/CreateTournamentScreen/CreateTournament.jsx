...
//           <Picker
//             selectedValue={pronosticFrequency}
//             style={{ flex: 1 }}
//             onValueChange={(itemValue) => setPronosticFrequency(itemValue)}
//           >
//             {tournamentType === "League" ? (
//               <>
//                 <Picker.Item label="Weekly" value="weekly" />
//                 <Picker.Item label="Monthly" value="monthly" />
//                 <Picker.Item label="Half Season" value="half-season" />
//                 <Picker.Item label="Full Season" value="full-season" />
//               </>
//             ) : (
//               <>
//                 <Picker.Item label="Daily" value="daily" />
//                 <Picker.Item label="Weekly" value="weekly" />
//                 <Picker.Item label="Full Cup" value="full-cup" />
//               </>
//             )}
//           </Picker>
//         </View>{" "}
